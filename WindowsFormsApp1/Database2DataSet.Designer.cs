...
namespace WindowsFormsApp1 {
    ...
    public partial class Database2DataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public StudentRow AddStudentRow(string Ime, string Prezime) {
...
namespace WindowsFormsApp1.Database2DataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Student` WHERE ((`ID` = ?) AND ((? = 1 AND `Ime` IS NULL) OR (`Ime` " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Student` (`Ime`, `Prezime`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Student` SET `Ime` = ?, `Prezime` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Ime, Prezime FROM Student";
