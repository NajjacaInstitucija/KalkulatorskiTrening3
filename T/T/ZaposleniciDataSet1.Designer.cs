...
namespace T {
    ...
    public partial class ZaposleniciDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ZaposleniciDataTable : global::System.Data.TypedTableBase<ZaposleniciRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ZaposleniciRow AddZaposleniciRow(string Username, string Password, bool IsManager) {
        ...
        public partial class ZaposleniciRow : global::System.Data.DataRow {
            ...
            public bool IsManager {
                get {
                    try {
                        return ((bool)(this[this.tableZaposlenici.IsManagerColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'IsManager\' in table \'Zaposlenici\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableZaposlenici.IsManagerColumn] = value;
                }
            }
            ...
            public bool IsIsManagerNull() {
                return this.IsNull(this.tableZaposlenici.IsManagerColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetIsManagerNull() {
                this[this.tableZaposlenici.IsManagerColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace T.ZaposleniciDataSet1TableAdapters {
    ...
    public partial class ZaposleniciTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Zaposlenici` WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) O" +
                "R (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND" +
                " ((? = 1 AND `IsManager` IS NULL) OR (`IsManager` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Zaposlenici` (`Username`, `Password`, `IsManager`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Zaposlenici` SET `Username` = ?, `Password` = ?, `IsManager` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `Password` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `IsManager` IS NULL) OR (`IsManager` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Username, [Password], IsManager FROM Zaposlenici";
        ...
        public virtual int Delete(int Original_ID, string Original_Username, string Original_Password, bool Original_IsManager) {
        ...
        public virtual int Insert(string Username, string Password, bool IsManager) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, bool IsManager, int Original_ID, string Original_Username, string Original_Password, bool Original_IsManager) {
            if ((Username == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((bool)(Original_IsManager));
        ...
        public virtual int UpdateAll(ZaposleniciDataSet1 dataSet) {
            ...
            try {
                ...
                if ((this._zaposleniciTableAdapter != null)) {
                    ...
                    this._zaposleniciTableAdapter.Connection = ((global::System.Data.OleDb.OleDbConnection)(workConnection));
                    this._zaposleniciTableAdapter.Transaction = ((global::System.Data.OleDb.OleDbTransaction)(workTransaction));
                ...
                if ((this._zaposleniciTableAdapter != null)) {
                    this._zaposleniciTableAdapter.Connection = ((global::System.Data.OleDb.OleDbConnection)(revertConnections[this._zaposleniciTableAdapter]));
